...
floors[0].generators.add(Generator('elerium'))
floors[0].generators.add(Generator('dilithium'))
floors[0].microchips.add(Microchip('elerium'))
floors[0].microchips.add(Microchip('dilithium'))
f(State(floors, 0, 0))
